...
static void config_timer3(void) {
    ...
    // Establecer el valor del temporizador para que genere una interrupción cada 1 segundo
    TimerLoadSet(TIMER3_BASE, TIMER_A, (ui32SysClock - 1)*0.1);  // 120 millones de ciclos = 1 segundo
...
static void config_timer2(void) {
    ...
    // Establecer el valor del temporizador para que genere una interrupción cada 1 segundo
    TimerLoadSet(TIMER2_BASE, TIMER_A, (ui32SysClock - 1)*0.05);  // 120 millones de ciclos = 1 segundo
