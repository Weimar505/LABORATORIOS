...
main(void)
{
    ...
    MAP_TimerLoadSet(TIMER0_BASE, TIMER_A, g_ui32SysClock*0.25);  // Temporizador a 0.5 segundos inicialmente.
    ...
    while(1)
    {
        ...
        if (bButtonState && !g_bLastButtonState)
        {
            ...
            if (g_ui32TimerState == 0)
            {
                ...
                MAP_TimerLoadSet(TIMER0_BASE, TIMER_A, g_ui32SysClock*0.25);
            }
            else
            {
